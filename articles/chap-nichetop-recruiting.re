...
当時の社内システムは内製で20年モノ。結果、技術的負債超超超超超超大盛負債ペタマックス@<fn>{peyoung}状態になっていたので
...
　具体的に言語を指定したほうがいいなら
　Ruby(ないしRuby on Rails)、VB、C#、Javascript、Python、Scala、Java、PHP
...
という事が起こっております。そりゃ長期戦になるわ…という感じですね。
